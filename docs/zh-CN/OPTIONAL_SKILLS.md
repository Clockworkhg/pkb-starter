...
python scripts/install.py "D:\我的知识库" --profile student --dry-run   # 仅预览
...
python scripts/skill_manager.py --target "D:\我的知识库" --enabled

# 安装
python scripts/skill_manager.py --target "D:\我的知识库" --install deep-research-skills
python scripts/skill_manager.py --target "D:\我的知识库" --install-profile research --dry-run
...
python scripts/skill_manager.py --target "D:\我的知识库" --disable kanban-skill
python scripts/skill_manager.py --target "D:\我的知识库" --update-catalog
```
...
python scripts/install_skills.py --target "D:\我的知识库" --profile research --dry-run
python scripts/install_skills.py --target "D:\我的知识库" --profile custom
python scripts/install_skills.py --target "D:\我的知识库" --audit-only
```
...
```bash
# 从命令行
python scripts/install_skills.py --target "D:\我的知识库" --audit-only  # 检查已安装内容
