...
>
> **Current version**: v0.6.15-starter | 🆕 **Anti-degradation v1.0**: 15 bug fixes + E2E test suite | **Global bridge**: `/ask-pkb` from any project
...
- **v0.6.15-starter**: Current. Anti-degradation system (15 hook fixes + E2E tests), global bridge engine v1.0, sync pipeline binary handling + sanitize fix, Obsidian vault migration, manifest integrity (120 mappings / 0 dup).
