# PKB Starter ![version](https://img.shields.io/badge/version-v0.6.11--alpha-blue)

> **One command to rule your knowledge.** `/pkb <anything>` — throw in a URL, file, or idea. The LLM organizes everything.
>
> **Current version**: v0.6.11-alpha | 🆕 **Global query**: `/ask-pkb` from any project
...
- **v0.6.11-alpha**: Current. Global Knowledge Bridge: `/ask-pkb` skill for cross-project wiki queries, intelligent path detection (PKB_ROOT env var → auto-detect → config), v0.6.9→v0.6.11 migration guide, full documentation sweep.
